      ...
      'active': {
        ...
        dtmf: function(data) {
          ...
          if (data.digit === config.menuInput.admin) {
            ...
            channel.continueInDialplan({context: config.leaveConf.context, 
              ...
              else if (config.leaveConf.context === "" || 
                       config.leaveConf.extension === "") {
                console.log('continuing in dialplan after stasis app');
              }
              else {
